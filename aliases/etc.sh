...
function hugo_new() {
    ...
    # WARNING! The following command works only on mac!!
    # TODO(rushiagr): write a platform-independent version here
    sed -i '.bak' s/menu\ \=\ \"main\"/type\ \=\ \"post\"/g content/blog/$1
    rm content/blog/$1.bak # Remove backup file generated by mac version of 'sed'
